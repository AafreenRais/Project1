/*This java project dynamically handles DDL & DML operations. 
it allows you to dynamically create table of arbitrary size
(variable no of columns) and data type.
Based on the  datatype , an appropriate table is created which 
is manipulation via CRUD Operations. */
